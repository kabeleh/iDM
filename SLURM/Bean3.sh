...
#SBATCH --output %j.Bean.out
#SBATCH --error %j.Bean.err
...
run_with_retry "/home/users/u103677/iDM/Cobaya/MCMC/Bean_Planck_InitCond_MCMC.yml" \
    "${SLURM_JOB_ID}_BeanIC.txt" 20 &
PID1=$!

run_with_retry "/home/users/u103677/iDM/Cobaya/MCMC/BeanAdS_Planck_tracking_MCMC.yml" \
    "${SLURM_JOB_ID}_BeanAdSTrack.txt" 20 &
PID2=$!

run_with_retry "/home/users/u103677/iDM/Cobaya/MCMC/BeanAdS_Planck_InitCond_MCMC.yml" \
    "${SLURM_JOB_ID}_BeanAdSIC.txt" 20 &
PID3=$!
...
echo "BeanIC exit code: $EXIT1"
echo "BeanTrack exit code: $EXIT2"
echo "BeanAdSIC exit code: $EXIT3"
echo "============================================"

...
#SBATCH --output %j.BeanCos.out
#SBATCH --error %j.BeanCos.err
...
run_with_retry "/home/users/u103677/iDM/Cobaya/MCMC/Bean_Planck_InitCond_MCMC.yml" \
    "${SLURM_JOB_ID}_Bean.txt" 10 &
PID1=$!

run_with_retry "/home/users/u103677/iDM/Cobaya/MCMC/BeanAdS_Planck_InitCond_MCMC.yml" \
    "${SLURM_JOB_ID}_BeanAdS.txt" 10 &
PID2=$!

run_with_retry "/home/users/u103677/iDM/Cobaya/MCMC/cosine_Planck_InitCond_MCMC.yml" \
    "${SLURM_JOB_ID}_cosine.txt" 10 &
PID3=$!

run_with_retry "/home/users/u103677/iDM/Cobaya/MCMC/SqE_Planck_InitCond_MCMC.yml" \
    "${SLURM_JOB_ID}_SqE.txt" 10 &
PID4=$!

run_with_retry "/home/users/u103677/iDM/Cobaya/MCMC/power-law_Planck_InitCond_MCMC.yml" \
    "${SLURM_JOB_ID}_power-law.txt" 10 &
PID5=$!
...
echo "Bean exit code: $EXIT1"
echo "BeanAdS exit code: $EXIT2"
echo "Cosine exit code: $EXIT3"
echo "SqE exit code: $EXIT4"
echo "Power-law exit code: $EXIT5"
echo "============================================"

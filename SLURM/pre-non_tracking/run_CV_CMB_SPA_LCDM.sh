#!/bin/bash -l
#SBATCH --job-name=run_CV_CMB_SPA_LCDM
...
#SBATCH --output %j.run_CV_CMB_SPA_LCDM.out
#SBATCH --error %j.run_CV_CMB_SPA_LCDM.err
...
while [ $EXIT_CODE -eq 143 ] && [ $RETRY_COUNT -lt $MAX_RETRIES ]; do
    ...
    srun --cpus-per-task=$SLURM_CPUS_PER_TASK cobaya-run /home/users/u103677/iDM/Cobaya/MCMC/CV_CMB_SPA_LCDM.yml --resume
    EXIT_CODE=$?

...
run_with_retry "/home/users/u103677/iDM/Cobaya/MCMC/hyperbolic_Planck_InitCond_MCMC.yml" \
    "${SLURM_JOB_ID}_hyperIC.txt" 30 &
PID1=$!

run_with_retry "/home/users/u103677/iDM/Cobaya/MCMC/hyperbolic_Planck_tracking_MCMC.yml" \
    "${SLURM_JOB_ID}_hyperbolicTrack.txt" 30 &
PID2=$!
...
echo "hyperIC exit code: $EXIT1"
echo "hyperbolicTrack exit code: $EXIT2"

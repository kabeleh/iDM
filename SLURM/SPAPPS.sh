...
#SBATCH --output %j.SPAPPS.out
#SBATCH --error %j.SPAPPS.err
...
## Task execution
srun -n 4 --mpi=pmi2 --exclusive --cpus-per-task=$SLURM_CPUS_PER_TASK --cpu-bind=threads singularity exec -B /project/project_465002956 -B /scratch/project_465002956 cobaya.sif cobaya-run /project/project_465002956/iDM/Cobaya/MCMC/hyperbolic_SPA_PPS_DESI_InitCond_MCMC.yml --resume --allow-changes
srun_exit=$?

...
run_pipeline_with_retry "${SLURM_JOB_ID}_hyperbolic_PP_Swamp.txt" 10 \
    "/home/users/u103677/iDM/Cobaya/MCMC/hyperbolic_Planck_PP_DESI_InitCond_MCMC_Swamp.yml" \
    "/home/users/u103677/iDM/Cobaya/MCMC/hyperbolic_Planck_PP_DESI_InitCond_MCMC_Swamp_minimizer.yml" &
PID1=$!

run_pipeline_with_retry "${SLURM_JOB_ID}_hyperbolic_PPS_Swamp.txt" 10 \
    "/home/users/u103677/iDM/Cobaya/MCMC/hyperbolic_Planck_PPS_DESI_InitCond_MCMC_Swamp.yml" \
    "/home/users/u103677/iDM/Cobaya/MCMC/hyperbolic_Planck_PPS_DESI_InitCond_MCMC_Swamp_minimizer.yml" &
PID2=$!

run_pipeline_with_retry "${SLURM_JOB_ID}_pNG_Swamp.txt" 10 \
    "/home/users/u103677/iDM/Cobaya/MCMC/pNG_Planck_InitCond_MCMC_Swamp.yml" \
    "/home/users/u103677/iDM/Cobaya/MCMC/pNG_Planck_InitCond_MCMC_Swamp_minimizer.yml" &
PID3=$!

run_pipeline_with_retry "${SLURM_JOB_ID}_pNG_PP_Swamp.txt" 10 \
    "/home/users/u103677/iDM/Cobaya/MCMC/pNG_Planck_PP_InitCond_MCMC_Swamp.yml" \
    "/home/users/u103677/iDM/Cobaya/MCMC/pNG_Planck_PP_InitCond_MCMC_Swamp_minimizer.yml" &
PID4=$!

run_pipeline_with_retry "${SLURM_JOB_ID}_pNG_PPS_Swamp.txt" 10 \
    "/home/users/u103677/iDM/Cobaya/MCMC/pNG_Planck_PPS_InitCond_MCMC_Swamp.yml" \
    "/home/users/u103677/iDM/Cobaya/MCMC/pNG_Planck_PPS_InitCond_MCMC_Swamp_minimizer.yml" &
PID5=$!
...
echo "Hyperbolic PP Swamp exit code: $EXIT1"
echo "Hyperbolic PPS Swamp exit code: $EXIT2"
echo "pNG Swamp exit code: $EXIT3"
echo "pNG Swamp PP DESI pipeline exit code: $EXIT4"
echo "pNG Swamp PPS DESI pipeline exit code: $EXIT5"
echo "============================================"

#!/bin/bash -l
#SBATCH --job-name=run_cobaya_mcmc_fast_Run1_Planck_2018_pNG_InitCond_uncoupled
...
while [ $EXIT_CODE -eq 143 ] && [ $RETRY_COUNT -lt $MAX_RETRIES ]; do
    ...
    srun --cpus-per-task=$SLURM_CPUS_PER_TASK cobaya-run /home/users/u103677/iDM/Cobaya/MCMC/cobaya_mcmc_fast_Run1_Planck_2018_pNG_InitCond_uncoupled.yml --resume
    EXIT_CODE=$?

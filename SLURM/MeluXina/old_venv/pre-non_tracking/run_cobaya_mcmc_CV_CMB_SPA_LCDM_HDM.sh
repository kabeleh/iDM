...
#SBATCH --output %j.HDM_SPA_LCDM.out
#SBATCH --error %j.HDM_SPA_LCDM.err
...
srun --cpus-per-task=$SLURM_CPUS_PER_TASK cobaya-run /home/users/u103677/iDM/Cobaya/MCMC/cobaya_mcmc_CV_CMB_SPA_LCDM_HDM.yml --resume

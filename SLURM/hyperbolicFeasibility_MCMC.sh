#!/bin/bash -l
#SBATCH --job-name=hyperfeasibilityMCMC
...
#SBATCH --time 6:00:00
#SBATCH --output %j.hyperfeasibilityMCMC.out
#SBATCH --error %j.hyperfeasibilityMCMC.err
...
while [ $EXIT_CODE -eq 143 ] && [ $RETRY_COUNT -lt $MAX_RETRIES ]; do
    ...
    srun --cpus-per-task=$SLURM_CPUS_PER_TASK cobaya-run /home/users/u103677/iDM/Cobaya/MCMC/hyperbolic_feasibility_MCMC.yml --resume
    EXIT_CODE=$?

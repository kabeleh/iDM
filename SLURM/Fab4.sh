...
#SBATCH --output %j.Fab4.out
#SBATCH --error %j.Fab4.err
...
echo "HyperTracking exit code: $EXIT1"
# echo "pNG exit code: $EXIT2"
echo "Power-law exit code: $EXIT3"

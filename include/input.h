...
#define class_read_string(name, destination)                                    \
  do                                                                            \
  {                                                                             \
    char string_temp[_ARGUMENT_LENGTH_MAX_];                                    \
    int flag_temp;                                                              \
...
#define class_read_flag(name, destination)                                                   \
  ...
  {                                                                                          \
    ...
    if (flag_temp == _TRUE_)                                                                 \
    {                                                                                        \
      if (string_begins_with(string_temp, 'y') || string_begins_with(string_temp, 'Y'))      \
      {                                                                                      \
        destination = _TRUE_;                                                                \
      }                                                                                      \
      else if (string_begins_with(string_temp, 'n') || string_begins_with(string_temp, 'N')) \
      {                                                                                      \
        destination = _FALSE_;                                                               \
      }                                                                                      \
      else                                                                                   \
